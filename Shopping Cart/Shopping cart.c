#include<stdio.h>
#include<stdlib.h>
void additem();//declaration of add item
void deleteitem();//declaration of delete item
void bill_info();//declaration of bill_info function
void display();//

int stock[5][3]={{0,0,0},{1,20,100},{2,52,200},{3,14,150},{4,21,250}};//array of stocks present
typedef struct{
                int code;
                int quantity;
                float cost;
              }cart; //structure defined for cart
cart c[10]; //variable of cart declared
int inum=0;
float total=0;
...
void additem() //function definition
{
...
void deleteitem() //function definition
{
...
void bill_info() //function definition
{
    int i;
    total=0;
